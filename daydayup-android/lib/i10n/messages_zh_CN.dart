...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m2(number) => "${Intl.plural(number, zero: '还没有便签详情哦 ', one: '1 项 ', other: '${number} 项 ')}";

  static m3(taskNumbers) => "${Intl.plural(taskNumbers, zero: '你还没有写过便签清单呢.\n快快开始吧.', one: '下面你的便签清单.\n ', many: '下面是你的便签清单,\n今天, 你有 ${taskNumbers} 个便签. ', other: '下面是你的便签清单,\n今天, 你有 ${taskNumbers} 个便签. ')}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "addTask" : MessageLookupByLibrary.simpleMessage("添加便签"),
    "appName" : MessageLookupByLibrary.simpleMessage("爆米花便签"),
    ...
    "writeAtLeastOneTaskItem" : MessageLookupByLibrary.simpleMessage("请至少写下一个便签哦"),
