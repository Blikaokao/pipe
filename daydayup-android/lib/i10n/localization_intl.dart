...
class IntlLocalizations {
  ...
  String get dataAnalysis => Intl.message('Data Analysis',name: 'dataAnalysis',desc:'数据统计');
  ...
  String get voiceInput => Intl.message('Voice', name: 'voiceInput', desc: '语音输入',);
  String get textInput => Intl.message('Text', name: 'textInput', desc: '文本输入',);
  String get photoInput => Intl.message('Photo', name: 'photoInput', desc: '图片输入',);
  String get importIn => Intl.message('ImportIn', name: 'importIn', desc: '导入',);
  ...
  String get phone => Intl.message('手机号', name: 'phone', desc: '手机号',);
  String get password => Intl.message('PASSWORD', name: 'password', desc: '密码',);
  String get inputPhone => Intl.message('输入手机号', name: 'inputPhone', desc: '输入手机号',);
  ...
  String get phoneCantBeEmpty => Intl.message('手机号不能为空', name: 'phoneCantBeEmpty', desc: '手机号不能为空',);
  String get phoneIncorrectFormat => Intl.message('手机号格式不正确', name: 'phoneIncorrectFormat', desc: '手机号格式不正确',);
  String get passwordCantBeEmpty => Intl.message('password cannot be empty', name: 'passwordCantBeEmpty', desc: '密码不能为空',);
  String get passwordTooShort => Intl.message('password length cannot be less than 6 digits', name: 'passwordTooShort', desc: '密码长度不能小于6位',);
  ...
  String get phoneAccount => Intl.message('手机账号', name: 'phoneAccount', desc: '手机账号',);
  String get setPhoneAccount => Intl.message('请设置你的手机账号', name: 'setPhoneAccount', desc: '请设置你的手机账号',);
  ...
  String get checkYourEmail => Intl.message('please check your email account', name: 'checkYourEmail', desc: '请检查你的手机号',);
  String get checkYourEmailOrPassword => Intl.message('请检查你的手机号或者密码', name: 'checkYourPhoneOrPassword', desc: '请检查你的手机号或者密码',);
  ...
  String get addTask => Intl.message('add a task', name: 'addTask', desc: '添加子任务',);
