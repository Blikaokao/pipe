...
// final kEvents = LinkedHashMap<DateTime, List<TaskBean>>(
//   equals: isSameDay,
...
//         item % 4 + 1, (index) => TaskBean('Event $item | ${index + 1}')));
...
class MainPageModel extends ChangeNotifier {
  ...
  void dispose() {
    ...
    globalModel.mainPageModel = null;
