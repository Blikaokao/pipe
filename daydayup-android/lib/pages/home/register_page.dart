          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Form(
                key: model.phoneKey,
                child: TextFormField(
                  focusNode: model.phoneFocusNode..addListener((){
                    if(!model.phoneFocusNode.hasFocus){
                      model.phoneKey.currentState.validate();
                    }
                  }),
                  validator: (text) => model.logic.validatorPhone(text),
                  decoration: InputDecoration(
                    filled: true,
                    prefixIcon: Icon(Icons.phone),
                    fillColor: Colors.transparent,
                    hintText: IntlLocalizations.of(context).setPhoneAccount,
                    labelText: IntlLocalizations.of(context).phoneAccount,
                  ),
