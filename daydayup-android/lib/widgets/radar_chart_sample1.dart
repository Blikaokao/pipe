...
class RadarChartSample1 extends StatefulWidget {
  final List<num> typelist;
  RadarChartSample1(this.typelist);
  ...
  List<RawDataSet> rawDataSets() {
    return [
      ...
      RawDataSet(
        ...
        color: boxingColor,
        values: [
          widget.typelist[0].toDouble(),
          widget.typelist[1].toDouble(),
          widget.typelist[2].toDouble()
        ],
      ),
    ];
  }
