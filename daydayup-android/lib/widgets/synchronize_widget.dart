    ...
    ApiService.instance.login(
      ...
      success: (LoginBean loginBean) {
        ...
        SharedUtil.instance.saveString(Keys.account, account).then((value){
          SharedUtil.instance.saveString(Keys.currentUserName, loginBean.userBeans[0].userName);
          SharedUtil.instance.saveString(Keys.id, loginBean.userBeans[0].id.toString());
          ...
          //   }
          // }
          widget.mainPageModel.currentUserName = loginBean.userBeans[0].userName;
          ///检测是否需要进行本地与云端的数据同步
