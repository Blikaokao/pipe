...
public class CommonDateUtil {
	...
	public static final String[] zodiacArray = { "��", "��", "��", "��", "��", "ţ", "��", "��", "��", "��", "��", "��" };

	public static final String[] constellationArray = { "ˮƿ��", "˫����", "ĵ����", "��ţ��", "˫����", "��з��", "ʨ����", "��Ů��", "�����",
			"��Ы��", "������", "ħ����" };
	...
	public static String formatDate(Date date) {
		...
		if (offset >= 5184000000L) {
			return ((offset + 1296000000L) / 2592000000L) + "����" + pos;
		}
		if (offset > 604800000L) {
			return ((offset + 302400000L) / 604800000L) + "��" + pos;
		}
		if (offset > 86400000L) {
			return ((offset + 43200000L) / 86400000L) + "��" + pos;
		}
		if (offset > 3600000L) {
			return ((offset + 1800000L) / 3600000L) + "Сʱ" + pos;
		}
		if (offset > 60000L) {
			return ((offset + 30000L) / 60000L) + "����" + pos;
		}
		return (offset / 1000L) + "��" + pos;
	}
